...
class ViewController: UIViewController
{
    ...
    let imgRemove = UIImage(named: "lamp_remove.jpg")
    ...
    @IBAction func btnLampRemove(_ sender: UIButton)
    {
        ...
        let offAction = UIAlertAction(title: "아니오, (off).", style: UIAlertAction.Style.default, handler: {ACTION in self.lampImg.image = self.imgOff
            self.isLampOn = false
        })
        let onAction = UIAlertAction(title: "아니오, (on).", style: UIAlertAction.Style.default)
        {
